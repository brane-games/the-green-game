...
uniform float uv_scale:hint_range(0.01, 100.0) = 31;
uniform float r_uv_scale:hint_range(0.01, 200.0) = 1;
...
uniform vec4 roughness_texture_channel = vec4(0.33,0.33,0.33, 0);
...
void fragment(){
	...
	ROUGHNESS = roughness_tex * m_blend3.g;
	METALLIC = 0.0;
}